                    ...
                    children: [
                      Flexible(
                        child: Material(
                          ...
                          color: Colors.white,
                          child: ImgContainer(
                            selected: widget.properties.shirtType == ShirtType.polo,
                            child: Image.asset(
                      ...
                      Flexible(
                        ...
                        child: Material(
                          ...
                          color: Colors.white,
                          child: ImgContainer(
                            selected: widget.properties.shirtType == ShirtType.t_shirt,
                            child: Image.asset(
                ...
                Flexible(
                  ...
                  child: widget.properties.shirtType == null
                    ...
                    child: AutoSizeText(
                      ...
                      ://TODO: the boxanimation blue
                  // not responsive after returning from the results screen
                  PageBuilder(widget.properties, widget.setDescription, key: ValueKey(widget.properties.shirtType,),),
                ),
              ],
            ),
          ),
