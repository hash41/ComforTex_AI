...
/// The GarmentProperties(Fit, scenario,..) selection screen on mobile
class GarmentPropertiesScreen extends StatefulWidget {
  /// Constructor allowing to pass the properties selected in the previous
  /// Screen
...
class _GarmentPropertiesScreenState extends State<GarmentPropertiesScreen>
  ...
  void initState() {
    ...
    _fillAnimation2 = Tween<double>(begin: 0, end: 1).animate(
    ...
    _fillAnimation3 = Tween<double>(begin: 0, end: 1).animate(
    ...
    _fillAnimation4 = Tween<double>(begin: 0, end: 1).animate(
                          ...
                          children: [
                              ...
                              children: [
                                Row(
                                  ...
                                  children: [
                                    ...
                                    Flexible(
                                      child: buildIconsColumn('Humidity',
                            ...
                            ElevatedButton(
                              ...
                              style: const ButtonStyle(
                                ...
                                fixedSize:
                                    WidgetStatePropertyAll(Size(200, 32)),
                                minimumSize:
  ...
  Positioned buildPositionedGreen(double value) {
    return Positioned.fill(
      //A Positioned.fill makes the child and
      // parent communicate the space correctly.
  ...
  List<Widget> _buildButtons(
    ...
    for (final value in enumValues) {
      final greyOut = greyedOut.contains(value);

      buttonChildren.add(
        ElevatedButton(
          onPressed: greyOut ? null : () => onChanged(value),
