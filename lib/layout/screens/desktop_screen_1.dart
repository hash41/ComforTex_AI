...
class _DesktopScreen1State extends State<DesktopScreen1> with TickerProviderStateMixin {
  ...
  Widget build(BuildContext context) {
    ...
    if(pageHeight < 500) {
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    AnimatedOpacity(
                      ...
                      opacity:
                      widget.properties.shirtType == null || widget.properties.material == null
                          ? 0
                          : 1,
                            ...
                            if (widget.properties.checkProperties()) {
                              await Navigator.push(
                                ...
                                PageRouteBuilder(
                                    ...
                                    pageBuilder: (_, __, ___) => WaitingScreen(widget.properties),
                                    transitionsBuilder: (context, animation1, animation2, child) {
                                      final curved = CurvedAnimation(parent: animation1,
                              ...
                              ScaffoldMessenger.of(context).showSnackBar(
                                SnackBar(
                                  content: Text('Please select all properties',
                                    style:
                                    GoogleFonts.roboto(
                                    ),
      ...
      return SafeArea(
        child: Scaffold(
          appBar: TopBar(height: Style.topBarHeightDesktop,loggedIn: true, options: true,),
          body: Column(
            mainAxisAlignment: MainAxisAlignment.spaceAround,
            children: [
              _createContainerDecoration(
                      ...
                      if (widget.properties.checkProperties()) {
                        await Navigator.push(
                          ...
                          PageRouteBuilder(
                              ...
                              pageBuilder: (_, __, ___) => WaitingScreen(widget.properties),
                              transitionsBuilder: (context, animation1, animation2, child) {
                                final curved = CurvedAnimation(parent: animation1, curve: Curves.easeInOutCubicEmphasized);
                                return ScaleTransition(
                                  scale: curved,
                                  child: child,
                                );
