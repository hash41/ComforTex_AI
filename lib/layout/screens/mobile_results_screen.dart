...
class MobileResultsScreen extends StatelessWidget {
  ...
  MobileResultsScreen(this.properties, {super.key});
            ...
            if(orientation == Orientation.portrait) {
              return Scaffold(
                appBar: TopBar(
                  ...
                  leading:  const MaterialBackButton(),loggedIn: true,
                  options: true,
                ),
                body: Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        Row(
                          ...
                          children: [
                            buildCriteriaColumn(
                                'Thermal', properties.prediction?.thermal),
                            const Flexible(child: Gap(14)),
                            buildCriteriaColumn(
                                'Moisture', properties.prediction?.moisture),
                            const Flexible(child: Gap(14)),
                            buildCriteriaColumn(
                                'Comfort', properties.prediction?.comfort),
                          ],
                        ),
                        const Gap(24),
                        const Divider(
